...
namespace Riva.AnnouncementPreferences.Core.IntegrationEvents.UserIntegrationEvents
{
    public class UserFlatForRentAnnouncementPreferenceUpdatedIntegrationEvent : IntegrationEventBase
    {
        ...
        public UserFlatForRentAnnouncementPreferenceUpdatedIntegrationEvent(Guid correlationId, DateTimeOffset creationDate,
            Guid userId, Guid flatForRentAnnouncementPreferenceId, Guid cityId, decimal? priceMin, 
            decimal? priceMax, int? roomNumbersMin, int? roomNumbersMax, IEnumerable<Guid> cityDistricts) : base(correlationId, creationDate)
        {
            UserId = userId;
