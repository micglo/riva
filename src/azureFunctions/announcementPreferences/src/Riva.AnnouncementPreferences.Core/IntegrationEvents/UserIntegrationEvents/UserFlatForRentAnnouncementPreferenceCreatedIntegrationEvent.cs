...
namespace Riva.AnnouncementPreferences.Core.IntegrationEvents.UserIntegrationEvents
{
    public class UserFlatForRentAnnouncementPreferenceCreatedIntegrationEvent : IntegrationEventBase
    {
        ...
        public UserFlatForRentAnnouncementPreferenceCreatedIntegrationEvent(Guid correlationId, DateTimeOffset creationDate, 
            Guid userId, Guid flatForRentAnnouncementPreferenceId, string userEmail, Guid cityId, bool serviceActive, 
            AnnouncementSendingFrequency announcementSendingFrequency, decimal? priceMin, decimal? priceMax, 
            int? roomNumbersMin, int? roomNumbersMax, IEnumerable<Guid> cityDistricts) : base(correlationId, creationDate)
        {
            UserId = userId;
