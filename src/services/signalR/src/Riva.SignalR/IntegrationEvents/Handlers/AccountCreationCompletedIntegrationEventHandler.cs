...
{
    public class AccountCreationCompletedIntegrationEventHandler : IIntegrationEventHandler<AccountCreationCompletedIntegrationEvent>
    {
        private readonly IHubService _hubService;
        private readonly ILogger _logger;

        public AccountCreationCompletedIntegrationEventHandler(IHubService hubService, ILogger logger)
        {
            _hubService = hubService;
            _logger = logger;
        }

        public Task HandleAsync(AccountCreationCompletedIntegrationEvent integrationEvent, CancellationToken cancellationToken = default)
        {
            try
            {
