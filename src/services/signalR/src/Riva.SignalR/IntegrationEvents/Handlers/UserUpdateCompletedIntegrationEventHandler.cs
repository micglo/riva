...
{
    public class UserUpdateCompletedIntegrationEventHandler : IIntegrationEventHandler<UserUpdateCompletedIntegrationEvent>
    {
        private readonly IHubService _hubService;
        private readonly ILogger _logger;

        public UserUpdateCompletedIntegrationEventHandler(IHubService hubService, ILogger logger)
        {
            _hubService = hubService;
            _logger = logger;
        }

        public Task HandleAsync(UserUpdateCompletedIntegrationEvent integrationEvent, CancellationToken cancellationToken = default)
        {
            try
            {
