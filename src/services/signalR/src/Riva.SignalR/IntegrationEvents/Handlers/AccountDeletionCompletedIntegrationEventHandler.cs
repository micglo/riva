...
{
    public class AccountDeletionCompletedIntegrationEventHandler : IIntegrationEventHandler<AccountDeletionCompletedIntegrationEvent>
    {
        private readonly IHubService _hubService;
        private readonly ILogger _logger;

        public AccountDeletionCompletedIntegrationEventHandler(IHubService hubService, ILogger logger)
        {
            _hubService = hubService;
            _logger = logger;
        }

        public Task HandleAsync(AccountDeletionCompletedIntegrationEvent integrationEvent, CancellationToken cancellationToken = default)
        {
            try
            {
