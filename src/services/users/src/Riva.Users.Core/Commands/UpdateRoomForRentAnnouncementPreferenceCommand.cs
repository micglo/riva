...
{
    public class UpdateRoomForRentAnnouncementPreferenceCommand : ICommand
    {
        ...
        public UpdateRoomForRentAnnouncementPreferenceCommand(Guid roomForRentAnnouncementPreferenceId, Guid userId, Guid cityId,
            decimal? priceMin, decimal? priceMax, RoomTypeEnumeration roomType, IEnumerable<Guid> cityDistricts)
        {
