...
namespace Riva.Users.Infrastructure.DataAccess.RivaUsersSqlServer.Migrations
{
    ...
    [Migration("20200430230957_Add_AnnouncementPreferenceCityDistricts_Table")]
    partial class Add_AnnouncementPreferenceCityDistricts_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Riva.Users.Infrastructure.DataAccess.RivaUsersSqlServer.Entities.AnnouncementPreferenceCityDistrictEntity", b =>
                {
                    b.Property<Guid>("AnnouncementPreferenceId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CityDistrictId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("AnnouncementPreferenceId", "CityDistrictId");

                    b.HasIndex("CityDistrictId");

                    b.ToTable("AnnouncementPreferenceCityDistricts");
                });
            ...
            modelBuilder.Entity("Riva.Users.Infrastructure.DataAccess.RivaUsersSqlServer.Entities.AnnouncementPreferenceCityDistrictEntity", b =>
                {
                    b.HasOne("Riva.Users.Infrastructure.DataAccess.RivaUsersSqlServer.Entities.AnnouncementPreferenceEntity", "AnnouncementPreference")
                        .WithMany("AnnouncementPreferenceCityDistricts")
                        .HasForeignKey("AnnouncementPreferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Riva.Users.Infrastructure.DataAccess.RivaUsersSqlServer.Entities.CityDistrictEntity", "CityDistrict")
                        .WithMany("AnnouncementPreferenceCityDistricts")
