...
{
    public class UserFlatForRentAnnouncementPreferenceAddedDomainEventHandlerTest
    {
        private readonly Mock<IDomainEventStore> _domainEventStoreMock;
        private readonly IDomainEventHandler<UserFlatForRentAnnouncementPreferenceAddedDomainEvent> _domainEventHandler;

        public UserFlatForRentAnnouncementPreferenceAddedDomainEventHandlerTest()
        {
            _domainEventStoreMock = new Mock<IDomainEventStore>();
            _domainEventHandler = new UserFlatForRentAnnouncementPreferenceAddedDomainEventHandler(_domainEventStoreMock.Object);
        }
