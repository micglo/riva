...
{
    public class AccountLoggedInDomainEventHandler : IDomainEventHandler<AccountLoggedInDomainEvent>
    {
        ...
        public Task HandleAsync(AccountLoggedInDomainEvent domainEvent, CancellationToken cancellationToken = default)
        {
