...
{
    public class AccountConfirmedDomainEventHandler : IDomainEventHandler<AccountConfirmedDomainEvent>
    {
        ...
        public Task HandleAsync(AccountConfirmedDomainEvent domainEvent, CancellationToken cancellationToken = default)
        {
